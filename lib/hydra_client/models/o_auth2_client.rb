...
module HydraClient
  class OAuth2Client
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allowed_cors_origins')
      ...
      if attributes.has_key?(:'backchannel_logout_session_required')
        self.backchannel_logout_session_required = attributes[:'backchannel_logout_session_required']
      end

      if attributes.has_key?(:'backchannel_logout_uri')
      ...
      if attributes.has_key?(:'client_secret_expires_at')
        self.client_secret_expires_at = attributes[:'client_secret_expires_at']
      end

      if attributes.has_key?(:'client_uri')
      ...
      if attributes.has_key?(:'frontchannel_logout_session_required')
        self.frontchannel_logout_session_required = attributes[:'frontchannel_logout_session_required']
      end

      if attributes.has_key?(:'frontchannel_logout_uri')
      ...
      if attributes.has_key?(:'logo_uri')
      ...
      if attributes.has_key?(:'policy_uri')
        self.policy_uri = attributes[:'policy_uri']
      end

      if attributes.has_key?(:'post_logout_redirect_uris')
      ...
      if attributes.has_key?(:'sector_identifier_uri')
      ...
      if attributes.has_key?(:'token_endpoint_auth_method')
        self.token_endpoint_auth_method = attributes[:'token_endpoint_auth_method']
      end

      if attributes.has_key?(:'tos_uri')
      ...
      if attributes.has_key?(:'userinfo_signed_response_alg')
    ...
    def list_invalid_properties
      ...
      if !@scope.nil? && @scope !~ Regexp.new(/([\/a-zA-Z0-9\\.\\*]+\s?)+/)
        invalid_properties.push('invalid value for "scope", must conform to the pattern /([\/a-zA-Z0-9\\.\\*]+\s?)+/.')
      end
    ...
    def scope=(scope)
      if !scope.nil? && scope !~ Regexp.new(/([\/a-zA-Z0-9\\.\\*]+\s?)+/)
        fail ArgumentError, 'invalid value for "scope", must conform to the pattern /([\/a-zA-Z0-9\\.\\*]+\\s?)+/.'
      end
