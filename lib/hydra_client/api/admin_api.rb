...
module HydraClient
  class AdminApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [AcceptConsentRequest] :body 
    # @return [Array<(CompletedRequest, Fixnum, Hash)>] CompletedRequest data, response status code and response headers
    ...
    def create_json_web_key_set_with_http_info(set, opts = {})
      ...
      # resource path
      local_var_path = '/keys/{set}'.sub('{' + 'set' + '}', set.to_s)
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(OAuth2Client, Fixnum, Hash)>] OAuth2Client data, response status code and response headers
    ...
    def delete_json_web_key_with_http_info(kid, set, opts = {})
      ...
      # resource path
      local_var_path = '/keys/{set}/{kid}'.sub('{' + 'kid' + '}', kid.to_s).sub('{' + 'set' + '}', set.to_s)
    ...
    def delete_o_auth2_client_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/clients/{id}'.sub('{' + 'id' + '}', id.to_s)
    ...
    # @param consent_challenge 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ConsentRequest, Fixnum, Hash)>] ConsentRequest data, response status code and response headers
    ...
    # @param login_challenge 
    # @param [Hash] opts the optional parameters
    # @return [Array<(LoginRequest, Fixnum, Hash)>] LoginRequest data, response status code and response headers
    ...
    # @param logout_challenge 
    # @param [Hash] opts the optional parameters
    # @return [Array<(LogoutRequest, Fixnum, Hash)>] LogoutRequest data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :scope An optional, space separated list of required scopes. If the access token was not granted one of the scopes, the result of active will be false.
    # @return [Array<(OAuth2TokenIntrospection, Fixnum, Hash)>] OAuth2TokenIntrospection data, response status code and response headers
    def introspect_o_auth2_token_with_http_info(token, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'OAuth2TokenIntrospection')
      if @api_client.config.debugging
    ...
    # @option opts [Integer] :limit The maximum amount of policies returned.
    # @option opts [Integer] :offset The offset from where to start looking.
    # @return [Array<(Array<OAuth2Client>, Fixnum, Hash)>] Array<OAuth2Client> data, response status code and response headers
    def list_o_auth2_clients_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<OAuth2Client>')
      if @api_client.config.debugging
    ...
    # @param subject 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<PreviousConsentSession>, Fixnum, Hash)>] Array<PreviousConsentSession> data, response status code and response headers
    def list_subject_consent_sessions_with_http_info(subject, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<PreviousConsentSession>')
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [JSONWebKey] :body 
    # @return [Array<(JSONWebKey, Fixnum, Hash)>] JSONWebKey data, response status code and response headers
