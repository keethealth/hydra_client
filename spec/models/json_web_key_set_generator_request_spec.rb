...
# Unit tests for HydraClient::JsonWebKeySetGeneratorRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JsonWebKeySetGeneratorRequest' do
  before do
    # run before each test
    @instance = HydraClient::JsonWebKeySetGeneratorRequest.new
  end
  ...
  describe 'test an instance of JsonWebKeySetGeneratorRequest' do
    it 'should create an instance of JsonWebKeySetGeneratorRequest' do
      expect(@instance).to be_instance_of(HydraClient::JsonWebKeySetGeneratorRequest)
    end
  end
